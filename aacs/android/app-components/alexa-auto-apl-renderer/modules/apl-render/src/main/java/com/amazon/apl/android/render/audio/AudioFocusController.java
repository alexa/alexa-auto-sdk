 ...
 */
package com.amazon.apl.android.render.audio;
...
public class AudioFocusController implements AudioManager.OnAudioFocusChangeListener, AutoCloseable {
     ...
     */
    public AudioFocusController(@NonNull AudioManager audioManager, @NonNull PlaybackController playbackController) {
