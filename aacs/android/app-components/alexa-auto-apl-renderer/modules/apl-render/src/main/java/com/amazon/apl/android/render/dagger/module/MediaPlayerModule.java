...
/**
 * Provides an instance of {@link com.amazon.apl.android.render.media.APLMediaPlayerProvider}.
 */
@Module(includes = {ApplicationModule.class})
public class MediaPlayerModule {
    /**
     * @return the {@link com.amazon.apl.android.render.media.APLMediaPlayerProvider}.
     */
    @Provides
    @ApplicationScope
    public APLMediaPlayerProvider provideMediaPlayerProvider(
            @NonNull final IAPLEventSender aplEventSender, @NonNull final IAPLTokenProvider aplTokenProvider) {
        return new APLMediaPlayerProvider(aplEventSender, aplTokenProvider);
    }
}
