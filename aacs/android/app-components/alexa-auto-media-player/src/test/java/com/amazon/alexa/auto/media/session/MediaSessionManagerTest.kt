...
class MediaSessionManagerTest {
    ...
    @Mock lateinit var mAudioManager : AudioManager
    ...
    fun setup() {
        ...
        `when`(mockContext!!.getSharedPreferences(anyString(), anyInt()).edit()).thenReturn(mockEditor)
        ...
        mClassUnderTest = MediaSessionManager(
            ...
            mMockController, mCustomActionProviders, mockPrefs, mAudioManager)
    }
    ...
    fun activateMediaSession() : Pair<MediaSessionCompat.Callback, Player.EventListener> {
        ...
        mClassUnderTest.setupMediaSessionCallbacks()
