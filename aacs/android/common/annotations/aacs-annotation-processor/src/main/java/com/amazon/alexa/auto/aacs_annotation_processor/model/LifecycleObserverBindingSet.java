...
public class LifecycleObserverBindingSet {
    private final Map<PackageElement, PackageBinding> packageBindingMap;

    public LifecycleObserverBindingSet() {
    ...
    public void addBinding(
            PackageElement packageElement, TypeElement classElement, LifecycleObserver lifecycleObserverBinding) {
        PackageBinding packageBinding = getPackageBinding(packageElement);
        LifecycleObserverClassBinding lifecycleObserverClassBinding =
                packageBinding.getLifecycleObserverClassBinding(classElement);
        lifecycleObserverClassBinding.addLifecycleObserverBinding(lifecycleObserverBinding);
    }
}
