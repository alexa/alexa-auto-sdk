...
public class NaviProviderBindingSet {
    ...
    public void addBinding(PackageElement packageElement, TypeElement classElement, NaviProvider naviProvider) {
        PackageBinding packageBinding = getPackageBinding(packageElement);
        NaviProviderClassBinding naviProviderClassBinding = packageBinding.getNaviProviderClassBinding(classElement);
        naviProviderClassBinding.addNaviProviderObserverBinding(naviProvider);
    }
}
