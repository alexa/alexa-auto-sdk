...
public class AASBConstants {
    ...
    public static class AlexaClient {
        ...
        public static final String DIALOG_STATE_EXPECTING = "EXPECTING";
    ...
    public static class CustomDomain {
        public static final String DIRECTIVE_NAMESPACE = "directiveNamespace";
        public static final String DIRECTIVE_NAME = "directiveName";
        public static final String DIRECTIVE_PAYLOAD = "directivePayload";
        public static final String CORRELATION_TOKEN = "correlationToken";
        public static final String MESSAGE_ID = "messageId";
        public static final String CONTEXT_NAMESPACE = "contextNamespace";
        public static final String CONTEXT = "context";
        public static final String EVENT_NAMESPACE = "eventNamespace";
        public static final String EVENT_NAME = "eventName";
        public static final String EVENT_PAYLOAD = "eventPayload";
        public static final String REQUIRES_CONTEXT = "requiresContext";
