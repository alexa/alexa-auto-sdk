...
public class Action {
    ...
    public static class CustomDomain {
        public static final String HANDLE_DIRECTIVE = "HandleDirective";
        public static final String CANCEL_DIRECTIVE = "CancelDirective";
        public static final String GET_CONTEXT = "GetContext";
        public static final String SEND_EVENT = "SendEvent";
        public static final String REPORT_DIRECTIVE_HANDLING_RESULT = "ReportDirectiveHandlingResult";
    }
    ...
    public static class APL {
        ...
        public static final String SET_PLATFORM_PROPERTY = "SetPlatformProperty";
        public static final String UPDATE_APL_RUNTIME_PROPERTIES = "UpdateAPLRuntimeProperties";
    }
    ...
    public static class AudioOutput {
        public static final String AUDIO_FOCUS_EVENT = "AudioFocusEvent";
        ...
        public static final String MAY_DUCK = "MayDuck";
        ...
        public static final String START_DUCKING = "StartDucking";
    ...
    public static class MediaPlaybackRequestor {
        public static final String REQUEST_MEDIA_PLAYBACK = "RequestMediaPlayback";
        public static final String MEDIA_PLAYBACK_RESPONSE = "MediaPlaybackResponse";
        public static final String SUCCESS = "SUCCESS";
        public static final String FAILED_CAN_RETRY = "FAILED_CAN_RETRY";
