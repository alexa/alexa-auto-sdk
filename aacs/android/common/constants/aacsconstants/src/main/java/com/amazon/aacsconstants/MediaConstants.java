...
public class MediaConstants {
    ...
    public static class AudioFocusEvent {
        public static final String REPORT_DUCKING_STARTED = "REPORT_DUCKING_STARTED";
        public static final String REPORT_DUCKING_STOPPED = "REPORT_DUCKING_STOPPED";
    }

    public static final String FOCUS_ACTION = "focusAction";
