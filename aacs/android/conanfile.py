...
class AlexaAutoClientService(ConanFile):
    ...
    options = {"aac_version": "ANY", "aac_modules": "ANY", "extra_modules": "ANY", "with_sensitive_logs": [True, False]}

    default_options = {
        "aac_version": "dev",
        "aac_modules": "core,aasb,alexa,bluetooth,apl,cbl,address-book,car-control,custom-domain,connectivity,messaging,metrics-proxy,navigation,phone-control,text-to-speech,text-to-speech-provider",
        "extra_modules": None,
