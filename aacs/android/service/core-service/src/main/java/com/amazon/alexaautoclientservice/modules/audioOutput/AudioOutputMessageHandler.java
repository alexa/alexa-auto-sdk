...
public class AudioOutputMessageHandler {
                ...
                mainHandler.post(() -> {
                    ...
                    switch (action) {
                        ...
                        case Action.AudioOutput.START_DUCKING:
                            handleStartDucking(payloadJson);
                            break;
                        case Action.AudioOutput.STOP_DUCKING:
                            handleStopDucking(payloadJson);
                            break;
    ...
    private void handleStartDucking(JSONObject payloadJson) {
        mCurrentMediaPlayer.startDucking();
    }

    private void handleStopDucking(JSONObject payloadJson) {
        mCurrentMediaPlayer.stopDucking();
    }
