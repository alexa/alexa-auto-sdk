...
class GStPluginsGoodConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(f"libsoup/2.72@{self.user}/{self.channel}")
    ...
    def _configure_meson(self):
        ...
        for plugin in ["gdk-pixbuf", "gtk3", "cairo", "v4l2", "taglib"]:
            meson.options[plugin] = "disabled"

        # Enable souphttp explicitly for HTTP streaming
