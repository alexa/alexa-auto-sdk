...
class AASBAddressBookEngineService : public aace::engine::aasb::AASBHandlerEngineService {
public:
    DESCRIBE("aasb.addressBook", VERSION("1.0"), DEPENDS(aace::engine::aasb::AASBEngineService))
