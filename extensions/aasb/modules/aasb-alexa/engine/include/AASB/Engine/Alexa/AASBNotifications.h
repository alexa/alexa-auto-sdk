...
#ifndef AASB_NOTIFICATIONS_H
#define AASB_NOTIFICATIONS_H
...
class AASBNotifications
        : public aace::alexa::Notifications
        , public std::enable_shared_from_this<AASBNotifications> {
private:
    AASBNotifications() = default;

    bool initialize(std::shared_ptr<aace::engine::aasb::MessageBrokerInterface> messageBroker);

public:
    static std::shared_ptr<AASBNotifications> create(
