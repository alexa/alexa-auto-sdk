...
class AASBAuthorizationEngineService : public aace::engine::aasb::AASBHandlerEngineService {
public:
    DESCRIBE("aasb.authorization", VERSION("1.0"), DEPENDS(aace::engine::aasb::AASBEngineService))
