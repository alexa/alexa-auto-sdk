...
class AASBDeviceUsageEngineService : public aace::engine::aasb::AASBHandlerEngineService {
public:
    DESCRIBE("aasb.deviceUsage", VERSION("1.0"), DEPENDS(aace::engine::aasb::AASBEngineService))
