...
#ifndef AUDIOOUTPUT_MUTEDSTATECHANGEDMESSAGE_H
#define AUDIOOUTPUT_MUTEDSTATECHANGEDMESSAGE_H
...
struct MutedStateChangedMessage {
    ...
    struct Payload {
        using MutedState = ::aasb::message::audio::MutedState;
...
#endif  // AUDIOOUTPUT_MUTEDSTATECHANGEDMESSAGE_H
