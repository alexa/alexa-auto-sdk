...
static const aace::engine::core::Version minRequiredVersion = VERSION("3.3");
...
AASBDeviceUsageEngineService::AASBDeviceUsageEngineService(const aace::engine::core::ServiceDescription& description) :
        aace::engine::aasb::AASBHandlerEngineService(description, minRequiredVersion, {"DeviceUsage"}) {
}
