...
class AASBNavigationEngineService : public aace::engine::aasb::AASBHandlerEngineService {
public:
    DESCRIBE("aasb.navigation", VERSION("1.0"), DEPENDS(aace::engine::aasb::AASBEngineService))
