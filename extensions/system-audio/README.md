...
1. Open the `config.json.linux` file (located in the `aac-sdk/extensions/system-audio/modules/system-audio/assets` directory).
...
1. Open the `config.json.qnx` file (located in the `aac-sdk/extensions/system-audio/modules/system-audio/assets` directory).
