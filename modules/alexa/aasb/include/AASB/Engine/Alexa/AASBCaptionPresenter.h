...
#ifndef AASB_ENGINE_ALEXA_AASB_CAPTION_PRESENTER_H
#define AASB_ENGINE_ALEXA_AASB_CAPTION_PRESENTER_H
...
class AASBCaptionPresenter
        : public aace::alexa::CaptionPresenter
        , public std::enable_shared_from_this<AASBCaptionPresenter> {
private:
    AASBCaptionPresenter() = default;

    bool initialize(std::shared_ptr<aace::engine::messageBroker::MessageBrokerInterface> messageBroker);

public:
    static std::shared_ptr<AASBCaptionPresenter> create(
