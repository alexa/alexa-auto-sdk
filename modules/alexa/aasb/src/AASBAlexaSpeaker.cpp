...
bool AASBAlexaSpeaker::initialize(std::shared_ptr<aace::engine::messageBroker::MessageBrokerInterface> messageBroker) {
    try {
...
void AASBAlexaSpeaker::speakerSettingsChanged(SpeakerType type, bool local, int8_t volume, bool mute) {
    try {
        ...
        message.payload.type = static_cast<aasb::message::alexa::alexaSpeaker::SpeakerType>(type);
