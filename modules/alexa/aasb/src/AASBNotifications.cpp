...
bool AASBNotifications::initialize(std::shared_ptr<aace::engine::messageBroker::MessageBrokerInterface> messageBroker) {
    try {
...
void AASBNotifications::setIndicator(aace::alexa::Notifications::IndicatorState state) {
    try {
        ...
        message.payload.state = static_cast<aasb::message::alexa::notifications::IndicatorState>(state);
