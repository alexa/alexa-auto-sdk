...
std::unique_ptr<DeviceSettingsDelegate> DeviceSettingsDelegate::createDeviceSettingsDelegate(
    ...
    auto deviceSettingStorage = alexaClientSDK::settings::storage::SQLiteDeviceSettingStorage::create( configurationRoot );
...
const DeviceSettingsDelegate::Configurations& DeviceSettingsDelegate::getConfigurations() const {
    return m_configurations;
}

const std::shared_ptr<alexaClientSDK::settings::DeviceSettingsManager>& DeviceSettingsDelegate::getDeviceSettingsManager() const {
    return m_deviceSettingsManager;
}

const std::shared_ptr<alexaClientSDK::settings::storage::DeviceSettingStorageInterface>& DeviceSettingsDelegate::getDeviceSettingStorage() const {
...
bool DeviceSettingsDelegate::configureDoNotDisturbSetting(
    ...
    try
    {
        ThrowIfNotNull(std::get<DeviceSettingsIndex::DO_NOT_DISTURB>(m_configurations).setting, "Do not disturb already configured");
        ThrowIfNull(dndCA, "dndCA is null");
        std::get<DeviceSettingsIndex::DO_NOT_DISTURB>(m_configurations) = SettingConfiguration<DeviceSettingsIndex::DO_NOT_DISTURB>{
...
bool DeviceSettingsDelegate::configureWakeWordConfirmationSetting() {
    try
    {
        ThrowIfNotNull(std::get<DeviceSettingsIndex::WAKEWORD_CONFIRMATION>(m_configurations).setting, "wake word confirmation already configured");

        auto eventSender = alexaClientSDK::settings::SettingEventSender::create( alexaClientSDK::capabilityAgents::aip::AudioInputProcessor::getWakeWordConfirmationMetadata(), m_connectionManager ) ;
        ...
        auto setting = alexaClientSDK::settings::Setting<alexaClientSDK::settings::WakeWordConfirmationSettingType>::create( alexaClientSDK::settings::WakeWordConfirmationSettingType::NONE, std::move( protocol ) );
        ThrowIfNull( setting, "createSettingFailed" );

        std::get<DeviceSettingsIndex::WAKEWORD_CONFIRMATION>(m_configurations) = SettingConfiguration<DeviceSettingsIndex::WAKEWORD_CONFIRMATION>{setting, metaData};
...
bool DeviceSettingsDelegate::configureSpeechConfirmationSetting() {
    ...
    try
    {
        ThrowIfNotNull(std::get<DeviceSettingsIndex::SPEECH_CONFIRMATION>(m_configurations).setting, "speech confirmation already configured");

        auto eventSender = alexaClientSDK::settings::SettingEventSender::create( alexaClientSDK::capabilityAgents::aip::AudioInputProcessor::getSpeechConfirmationMetadata(), m_connectionManager ) ;
        ThrowIfNull( eventSender, "createEventSenderFailed" );
        ...
        auto setting = alexaClientSDK::settings::Setting<alexaClientSDK::settings::SpeechConfirmationSettingType>::create( alexaClientSDK::settings::SpeechConfirmationSettingType::NONE, std::move( protocol ) );
        ThrowIfNull( setting, "createSettingFailed" );

        std::get<DeviceSettingsIndex::SPEECH_CONFIRMATION>(m_configurations) = SettingConfiguration<DeviceSettingsIndex::SPEECH_CONFIRMATION>{setting, metaData};
...
bool DeviceSettingsDelegate::configureTimeZoneSetting( const std::string& defaultValue ) {
    ...
    try
    {
        ThrowIfNotNull(std::get<DeviceSettingsIndex::TIMEZONE>(m_configurations).setting, "timezone already configured");
        ...
        std::get<DeviceSettingsIndex::TIMEZONE>(m_configurations) = SettingConfiguration<DeviceSettingsIndex::TIMEZONE>{setting, metaData};
...
bool DeviceSettingsDelegate::configureLocaleAndWakeWordsSettings(
    ...
    try
    {
        ...
        ThrowIfNotNull(std::get<DeviceSettingsIndex::WAKE_WORDS>(m_configurations).setting, "wake word already configured");
        ...
        auto localeEventSender = alexaClientSDK::settings::SettingEventSender::create( localeMetadata, m_connectionManager );
        ThrowIfNull( localeEventSender, "createLocaleEventSenderFailed" );

        auto wakeWordsEventSender = alexaClientSDK::settings::SettingEventSender::create( wakeWordsMetadata, m_connectionManager );
        ...
        auto setting = alexaClientSDK::settings::types::LocaleWakeWordsSetting::create(
            std::move( localeEventSender ),
            std::move( wakeWordsEventSender ),
            m_deviceSettingStorage,
            assetsManager );
        ThrowIfNull( setting, "createSettingFailed" );
...
bool DeviceSettingsDelegate::configureLocaleSetting(
    ...
    try
    {
        ...
        auto dummySender = alexaClientSDK::settings::SettingEventSender::create( alexaClientSDK::settings::SettingEventMetadata(), m_connectionManager );
        auto localeMetadata = alexaClientSDK::capabilityAgents::system::LocaleHandler::getLocaleEventsMetadata();
        auto localeEventSender = alexaClientSDK::settings::SettingEventSender::create( localeMetadata, m_connectionManager );
...
bool DeviceSettingsDelegate::configureAlarmVolumeRampSetting() {
    try
    {
        ThrowIfNotNull(std::get<DeviceSettingsIndex::ALARM_VOLUME_RAMP>(m_configurations).setting, "Alarm volume ramp already configured");

        auto eventSender = alexaClientSDK::settings::SettingEventSender::create( alexaClientSDK::capabilityAgents::alerts::AlertsCapabilityAgent::getAlarmVolumeRampMetadata(), m_connectionManager ) ;
        ThrowIfNull( eventSender, "createEventSenderFailed" );
        ...
        std::get<DeviceSettingsIndex::ALARM_VOLUME_RAMP>(m_configurations) = SettingConfiguration<DeviceSettingsIndex::ALARM_VOLUME_RAMP>{setting, metaData};
