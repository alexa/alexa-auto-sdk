...
std::shared_ptr<EndpointBuilderFactory> EndpointBuilderFactory::create(
    ...
    try {
        ...
        return std::shared_ptr<EndpointBuilderFactory>(
            new EndpointBuilderFactory(deviceInfo, contextManager, exceptionSender, alexaMessageSender));
...
std::unique_ptr<alexaClientSDK::avsCommon::sdkInterfaces::endpoints::EndpointBuilderInterface> EndpointBuilderFactory::
