...
bool SpeechSynthesizerEngineImpl::initialize(
    ...
    try
    {
        ...
        m_speechSynthesizerCapabilityAgent = alexaClientSDK::capabilityAgents::speechSynthesizer::SpeechSynthesizer::create( 
            shared_from_this(),
            messageSender,
            focusManager,
            contextManager,
...
std::shared_ptr<SpeechSynthesizerEngineImpl> SpeechSynthesizerEngineImpl::create(
    ...
    try 
    {
        ...
        ThrowIfNot( speechSynthesizerEngineImpl->initialize( audioOutputChannel, defaultEndpointBuilder, directiveSequencer, messageSender, focusManager, contextManager, attachmentManager, dialogUXStateAggregator, capabilitiesDelegate, speakerManager, exceptionSender ), "initializeSpeechSynthesizerEngineImplFailed" );
...
void SpeechSynthesizerEngineImpl::handlePrePlaybackStarted( SourceId id )
{
    try 
    {
        ...
        ALEXA_METRIC(LX(TAG, "executePlaybackStarted").d("dialogrequestid", m_directiveSequencer_lock->getDialogRequestId()),
...
void SpeechSynthesizerEngineImpl::handlePrePlaybackFinished( SourceId id )
{
    try 
    {
        ...
        ALEXA_METRIC(LX(TAG, "executePlaybackFinished").d("dialogrequestid", m_directiveSequencer_lock->getDialogRequestId()),
