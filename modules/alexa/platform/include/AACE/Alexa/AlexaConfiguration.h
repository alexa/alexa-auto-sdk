...
public:
     ...
     * @param [in] clientSecret The client secret used to authorize the client with AVS
     * @param [in] refreshToken The refresh token used to authorize the client with AVS
     */
