...
#ifndef AACE_TEST_UNIT_AVS_MOCK_ATTACHMENT_MANAGER_H
#define AACE_TEST_UNIT_AVS_MOCK_ATTACHMENT_MANAGER_H
...
#endif  // AACE_TEST_UNIT_AVS_MOCK_ATTACHMENT_MANAGER_H
