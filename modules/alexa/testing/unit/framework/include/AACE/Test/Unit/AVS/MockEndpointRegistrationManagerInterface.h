...
#ifndef AACE_TEST_UNIT_AVS_MOCK_ENDPOINT_REGISTRATION_MANAGER_INTERFACE_H
#define AACE_TEST_UNIT_AVS_MOCK_ENDPOINT_REGISTRATION_MANAGER_INTERFACE_H
...
public:
    ...
    MOCK_METHOD2(
        ...
        std::future<UpdateResult>(
            ...
            const std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::endpoints::EndpointModificationData>&
...
#endif  //AACE_TEST_UNIT_AVS_MOCK_ENDPOINT_REGISTRATION_MANAGER_INTERFACE_H
