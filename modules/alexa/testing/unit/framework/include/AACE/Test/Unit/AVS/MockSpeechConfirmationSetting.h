...
#ifndef AACE_TEST_UNIT_AVS_MOCK_SPEECH_CONFIRMATION_SETTING_H
#define AACE_TEST_UNIT_AVS_MOCK_SPEECH_CONFIRMATION_SETTING_H
...
#endif  //AACE_TEST_UNIT_AVS_MOCK_SPEECH_CONFIRMATION_SETTING_H
