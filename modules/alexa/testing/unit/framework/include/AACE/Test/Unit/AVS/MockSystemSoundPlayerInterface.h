...
#ifndef AACE_TEST_UNIT_AVS_MOCK_SYSTEM_SOUND_PLAYER_INTERFACE_H
#define AACE_TEST_UNIT_AVS_MOCK_SYSTEM_SOUND_PLAYER_INTERFACE_H
...
#endif  //AACE_TEST_UNIT_AVS_MOCK_SYSTEM_SOUND_PLAYER_INTERFACE_H
