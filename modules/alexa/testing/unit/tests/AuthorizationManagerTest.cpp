...
public:
    void SetUp() override {
        ...
        auto registrationManagerInterfaces = alexaClientSDK::registrationManager::createRegistrationManagerInterfaces(
            m_dataManager, m_avsConnectionManager, m_directiveSequencer, nullptr);
...
protected:
    std::shared_ptr<aace::engine::alexa::AuthorizationManager> createAuthorizationManager() {
        ...
        auto authorizationManager = AuthorizationManager::create(authorizationManagerStorage);
...
TEST_F(AuthorizationManagerTest, test_createAuthorizationManagerWithInvalidParameters) {
    ...
    auto authorizationManager = AuthorizationManager::create(nullptr);
