...
#include <AACE/Test/Unit/Wakeword/MockWakewordManagerServiceInterface.h>
#include <AACE/Test/Unit/Arbitrator/MockArbitratorServiceInterface.h>
...
public:
    void SetUp() override {
        ...
        m_mockWakewordService = std::make_shared<aace::test::unit::core::MockWakewordManagerServiceInterface>();
        m_mockArbitratorService = std::make_shared<aace::test::unit::core::MockArbitratorServiceInterface>();
    ...
    std::shared_ptr<aace::engine::alexa::SpeechRecognizerEngineImpl> createSpeechRecognizerEngineImpl(
        ...
        auto speechRecognizerEngineImpl = aace::engine::alexa::SpeechRecognizerEngineImpl::create(
                                              ...
                                              *m_alexaMockFactory->getDeviceSettingsDelegateMock(),
                                              ...
                                              m_mockWakewordService,
                                              createInitiatorVerifiers(),
                                              nullptr,
                                              m_mockArbitratorService);
...
protected:
    ...
    std::shared_ptr<aace::test::unit::core::MockWakewordManagerServiceInterface> m_mockWakewordService;
    std::shared_ptr<aace::test::unit::core::MockArbitratorServiceInterface> m_mockArbitratorService;
...
TEST_F(SpeechRecognizerEngineImplTest, concurrentStartCaptureEnableWakeWord) {
    ...
    speechRecognizerEngineImpl->onStateChanged(
        alexaClientSDK::avsCommon::avs::AgentId::getAlexaAgentId(),
