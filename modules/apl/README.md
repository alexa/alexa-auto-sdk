...
```
You can also generate the configuration programmatically by using the `aace::apl::config::APLConfiguration::createAlexaPresentationTimeoutConfig()` factory method.
