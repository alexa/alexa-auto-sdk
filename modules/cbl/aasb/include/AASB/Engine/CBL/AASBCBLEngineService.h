...
class AASBCBLEngineService : public aace::engine::messageBroker::MessageHandlerEngineService {
public:
    DESCRIBE("aasb.cbl", VERSION("1.0"), DEPENDS(aace::engine::messageBroker::MessageBrokerEngineService))
