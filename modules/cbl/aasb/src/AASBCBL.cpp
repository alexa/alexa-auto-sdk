...
bool AASBCBL::initialize(std::shared_ptr<aace::engine::messageBroker::MessageBrokerInterface> messageBroker) {
    try {
...
void AASBCBL::cblStateChanged(
    ...
    try {
        ...
        message.payload.state = static_cast<aasb::message::cbl::cbl::CBLState>(state);
        message.payload.reason = static_cast<aasb::message::cbl::cbl::CBLStateChangedReason>(reason);
