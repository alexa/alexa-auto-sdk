...
public:
     ...
     * @endcode
     *
     * @param [in] requestTimeout The timeout used for requesting code pair. The default value is 60s
     * @param [in] enableUserProfile To request user profile. The default value is @c false.
     */
    static std::shared_ptr<aace::core::config::EngineConfiguration> createCBLConfig(
