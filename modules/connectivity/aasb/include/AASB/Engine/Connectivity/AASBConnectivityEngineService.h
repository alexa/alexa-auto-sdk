...
class AASBConnectivityEngineService : public aace::engine::messageBroker::MessageHandlerEngineService {
public:
    DESCRIBE("aasb.connectivity", VERSION("1.0"), DEPENDS(aace::engine::messageBroker::MessageBrokerEngineService))
