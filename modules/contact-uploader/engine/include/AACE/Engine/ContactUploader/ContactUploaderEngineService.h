...
#ifndef AACE_ENGINE_CONTACTUPLOADER_CONTACTUPLOADER_ENGINE_SERVICE_H
#define AACE_ENGINE_CONTACTUPLOADER_CONTACTUPLOADER_ENGINE_SERVICE_H
...
#include "ContactUploaderEngineImpl.h"
