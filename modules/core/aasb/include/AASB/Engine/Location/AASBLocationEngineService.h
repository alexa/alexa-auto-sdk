...
class AASBLocationEngineService : public aace::engine::messageBroker::MessageHandlerEngineService {
public:
    DESCRIBE("aasb.location", VERSION("1.0"), DEPENDS(aace::engine::messageBroker::MessageBrokerEngineService))
