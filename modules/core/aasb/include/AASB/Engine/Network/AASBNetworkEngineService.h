...
class AASBNetworkEngineService : public aace::engine::messageBroker::MessageHandlerEngineService {
public:
    DESCRIBE("aasb.network", VERSION("1.0"), DEPENDS(aace::engine::messageBroker::MessageBrokerEngineService))
