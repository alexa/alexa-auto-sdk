...
bool AASBAudioInput::startAudioInput() {
    try {
        ...
        message.payload.audioType = static_cast<aasb::message::audio::audioInput::AudioInputAudioType>(m_type);
...
aace::core::MessageStream::Mode AASBAudioInput::AudioInputStreamHandler::getMode() {
    return aace::core::MessageStream::Mode::WRITE;
}
