...
class JFocusActionConfig : public EnumConfiguration<AudioOutputHandler::FocusAction> {
public:
    using T = AudioOutputHandler::FocusAction;

    const char* getClassName() override {
        return "com/amazon/aace/audio/AudioOutput$FocusAction";
    }
...
using JFocusAction = JEnum<AudioOutputHandler::FocusAction, JFocusActionConfig>;
