...
abstract public class AudioOutput extends NativeRef {
    ...
    public enum FocusAction {
         ...
         * @hideinitializer
         */
        REPORT_DUCKING_STARTED("REPORT_DUCKING_STARTED"),
         ...
         * @internal
         */
        private FocusAction(String name) {
            m_name = name;
        }
     ...
     * If platform implementation supports audio ducking, reduce the media player volume according to platform
     * guidelines.
     *
     */
    ...
    protected void audioFocusEvent(FocusAction action) {
        audioFocusEvent(getNativeRef(), action);
    }
    ...
    private native void audioFocusEvent(long nativeObject, FocusAction action);
