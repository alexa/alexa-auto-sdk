...
final public class Engine extends NativeRef {
    ...
    private MessageBroker mMessageBroker = null;
     ...
     */
    public final boolean configure(EngineConfiguration[] configurationList) {
     ...
     */
    public final boolean registerPlatformInterface(PlatformInterface platformInterface) {
        return registerPlatformInterface(getNativeRef(), platformInterface.getNativeRef());
    }

    /**
     * Returns the @c MessageBroker instance for the Engine
     *
     * @return @c MessageBroker
     *
    ...
    public final boolean setNativeEnv(String name, String value) {
    ...
    private native MessageBroker getMessageBroker(long nativeRef);
}
