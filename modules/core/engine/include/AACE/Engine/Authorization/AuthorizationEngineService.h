...
public:
    ...
    void addEventListener(std::shared_ptr<AuthorizationEventListenerInterface> eventListener) override;
    void removeEventListener(std::shared_ptr<AuthorizationEventListenerInterface> eventListener) override;
    /// @}
