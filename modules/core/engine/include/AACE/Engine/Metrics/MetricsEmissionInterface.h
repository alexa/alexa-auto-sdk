...
#ifndef AACE_ENGINE_METRICS_METRICSEMISSIONINTERFACE_H_
#define AACE_ENGINE_METRICS_METRICSEMISSIONINTERFACE_H_
...
#endif  // AACE_ENGINE_METRICS_METRICSEMISSIONINTERFACE_H_
