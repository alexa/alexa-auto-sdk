...
bool Sink::addRule( Level level, const std::string& source, const std::string& tag, const std::string& message, bool replace ) {
    return addRule( Rule::create( level, source, tag, message ), replace );
}

bool Sink::addRule( const std::string& level, const std::string& source, const std::string& tag, const std::string& message,  bool replace ) {
    return addRule( Rule::create( level, source, tag, message ), replace );
}

void Sink::emit( const std::string& source, const std::string& tag, Level level, std::chrono::system_clock::time_point time, const char* threadMoniker, const char* text )
{
...
Rule::Rule( Level level, const std::string& source, const std::string& tag, const std::string& message ) :
    m_level( level ), m_source( source ), m_sourceRegex( source ), m_tag( tag ), m_tagRegex( tag ), m_message( message ), m_messageRegex( message ) {
}
    
std::shared_ptr<Rule> Rule::create( Level level, const std::string& source, const std::string& tag, const std::string& message ) {
