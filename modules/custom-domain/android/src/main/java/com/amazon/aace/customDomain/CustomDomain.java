 ...
 * The implementation of the platform interface should handle receiving custom directives, sending custom events, contexts, 
 * processing cancel directive requests from AVS, and report the handling result back to Auto SDK engine. 
 * The implementation of the abstract APIs in this class MUST be thread-safe as they will be called by multiple threads when
...
abstract public class CustomDomain extends PlatformInterface {
   ...
   /**
     ...
     * with matching @c directiveNamespace and @c messageId and @c com.amazon.aace.customDomain.CustomDomain.ResultType.SUCCESS. Otherwise, if handling
     ...
     */
	public abstract void handleDirective(String directiveNamespace, String name, String payload, String correlationToken, String messageId);
     ...
     */
    public abstract void cancelDirective(String directiveNamespace, String name, String correlationToken, String messageId);
    ...
    * @li uncertaintyInMilliseconds (optional): The number of milliseconds that have elapsed since the property value was last confirmed. If omitted, the default value is 0.
    */
    public final void sendEvent(String eventNamespace, String name, String payload, boolean requiresContext, String correlationToken, String customContext) {
    ...
    private native void sendEvent(long nativeRef, String eventNamespace, String name, String payload, boolean requiresContext, String correlationToken, String customContext);
    private native void reportDirectiveHandlingResult(long nativeRef, String directiveNamespace, String messageId, ResultType result);
}