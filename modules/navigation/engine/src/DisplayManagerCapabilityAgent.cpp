...
static const alexaClientSDK::avsCommon::avs::NamespaceAndName SHOW_ALTERNATIVE_ROUTES{NAMESPACE, "ShowAlternativeRoutes"};
...
static const std::unordered_map<std::string, aace::navigation::Navigation::ControlDisplay> controlDisplayStringToEnumMap = {
    ...
    {"CENTER_MAP_ON_CURRENT_LOCATION",aace::navigation::Navigation::ControlDisplay::CENTER_MAP_ON_CURRENT_LOCATION},
...
static const std::unordered_map<std::string, aace::navigation::Navigation::AlternateRouteType> alternateRouteTypeStringToEnumMap = {
    ...
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ContextManagerInterface> contextManager )
{
    try
    {
        ...
        auto displayManagerCapabilityAgent = std::shared_ptr<DisplayManagerCapabilityAgent>( new DisplayManagerCapabilityAgent( navigationHandler, exceptionSender, messageSender, contextManager ) );
...
void DisplayManagerCapabilityAgent::handleDirectiveImmediately( std::shared_ptr<alexaClientSDK::avsCommon::avs::AVSDirective> directive ) {
...
alexaClientSDK::avsCommon::avs::DirectiveHandlerConfiguration displaymanager::DisplayManagerCapabilityAgent::getConfiguration() const
{
...
DisplayManagerCapabilityAgent::DisplayManagerCapabilityAgent( std::shared_ptr<aace::engine::navigation::NavigationHandlerInterface> navigationHandler, std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ExceptionEncounteredSenderInterface> exceptionSender,
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::MessageSenderInterface> messageSender,
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ContextManagerInterface> contextManager ) :
...
std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityConfiguration> getDisplayManagerCapabilityConfiguration() {
    ...
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_TYPE_KEY, DISPLAY_MANAGER_CAPABILITY_INTERFACE_TYPE} );
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_NAME_KEY, DISPLAY_MANAGER_CAPABILITY_INTERFACE_NAME} );
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_VERSION_KEY, DISPLAY_MANAGER_CAPABILITY_INTERFACE_VERSION} );
...
void DisplayManagerCapabilityAgent::sendExceptionEncounteredAndReportFailed( std::shared_ptr<DirectiveInfo> info, const std::string& message, alexaClientSDK::avsCommon::avs::ExceptionErrorType type )
{
...
void DisplayManagerCapabilityAgent::handleControlDisplayDirective(std::shared_ptr<DirectiveInfo> info)
{
    ...
    if( !result ) {
        AACE_ERROR(LX(TAG, "handleControlDisplayDirective").d("reason", rapidjson::GetParseError_En(result.Code())).d("messageId", info->directive->getMessageId()));
    ...
    if( !json.HasMember( "mode" ) ) {
        ...
        sendExceptionEncounteredAndReportFailed( info, "Missing mode value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    ...
    if(controlDisplayStringToEnumMap.find( mode ) == controlDisplayStringToEnumMap.end() ) {
        ...
        sendExceptionEncounteredAndReportFailed( info, "invalid mode value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
...
void DisplayManagerCapabilityAgent::handleShowAlternativeRoutesDirective( std::shared_ptr<DirectiveInfo> info )
{
    ...
    rapidjson::ParseResult result = json.Parse( &payload[0]);
    if( !result ) {
        AACE_ERROR(LX(TAG, "handleShowAlternativeRoutesDirective").d("reason", rapidjson::GetParseError_En(result.Code())).d("messageId", info->directive->getMessageId()));
        sendExceptionEncounteredAndReportFailed( info, "Unable to parse payload", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    if( !json.HasMember( "inquiryType" ) ) {
        AACE_ERROR(LX(TAG, "handleControlDisplayDirective").d("reason", "missing inquiryType value"));
        sendExceptionEncounteredAndReportFailed( info, "Missing inquiryType value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    ...
    if(alternateRouteTypeStringToEnumMap.find( mode ) == alternateRouteTypeStringToEnumMap.end() ) {
        ...
        sendExceptionEncounteredAndReportFailed( info, "invalid inquiryType value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    aace::navigation::Navigation::AlternateRouteType alternateRouteType = alternateRouteTypeStringToEnumMap.find( mode )->second;
...
void DisplayManagerCapabilityAgent::navigationError( aace::navigation::NavigationEngineInterface::ErrorType type, aace::navigation::NavigationEngineInterface::ErrorCode code, const std::string& description )
{
...
void DisplayManagerCapabilityAgent::showAlternativeRoutesSucceeded( const std::string& payload )
{
    m_executor.submit( [this, payload] {
        executeShowAlternativeRoutesSucceeded( payload );
    });
}

void DisplayManagerCapabilityAgent::executeNavigationEvent( aace::navigation::NavigationEngineInterface::EventName event )
{
...
void DisplayManagerCapabilityAgent::executeNavigationError( aace::navigation::NavigationEngineInterface::ErrorType type, aace::navigation::NavigationEngineInterface::ErrorCode code, const std::string& description )
{
    rapidjson::Document payload;
...
void displaymanager::DisplayManagerCapabilityAgent::controlDisplayFailed( std::string code, std::string description, std::string mode )
{
    rapidjson::Document payload( rapidjson::kObjectType );
    rapidjson::Document::AllocatorType& allocator = payload.GetAllocator();
    payload.AddMember("mode", rapidjson::Value( mode.c_str(), allocator ), allocator );
...
void DisplayManagerCapabilityAgent::showAlternativeRoutesFailed( std::string code, std::string description, std::string mode )
{
    rapidjson::Document payload( rapidjson::kObjectType );
    rapidjson::Document::AllocatorType& allocator = payload.GetAllocator();
...
std::string displaymanager::DisplayManagerCapabilityAgent::getMode( aace::navigation::NavigationEngineInterface::ErrorType type )
{
    std::string mode;
    switch( type ) {
        case aace::navigation::NavigationEngineInterface::ErrorType::ROUTE_OVERVIEW_FAILED:
...
std::unordered_set<std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityConfiguration>> DisplayManagerCapabilityAgent::getCapabilityConfigurations() {
    return m_capabilityConfigurations;
}

} // aace::engine::navigation::displaymanager
