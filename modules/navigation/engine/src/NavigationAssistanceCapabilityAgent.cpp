...
static const alexaClientSDK::avsCommon::avs::NamespaceAndName ANNOUNCE_ROAD_REGULATION{NAMESPACE, "AnnounceRoadRegulation"};
...
static const std::unordered_set<std::string> announceManeuverTypeValues = {
    "TURN",
    "LANE",
    "EXIT",
    "ENTER",
...
static const std::unordered_map<std::string, aace::navigation::Navigation::RoadRegulation> roadRegulationTypeStringToEnumMap = {
 ...
 */
static std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityConfiguration> getNavigationAssistanceCapabilityConfiguration();

std::shared_ptr<NavigationAssistanceCapabilityAgent> NavigationAssistanceCapabilityAgent::create( std::shared_ptr<NavigationHandlerInterface> navigationHandler, std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ExceptionEncounteredSenderInterface> exceptionSender, std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::MessageSenderInterface> messageSender,
std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ContextManagerInterface> contextManager )
{
    try
    {
        ...
        auto navigationAssistanceCapabilityAgent = std::shared_ptr<NavigationAssistanceCapabilityAgent>( new NavigationAssistanceCapabilityAgent( navigationHandler, exceptionSender, messageSender, contextManager ) );
...
void NavigationAssistanceCapabilityAgent::handleDirectiveImmediately( std::shared_ptr<alexaClientSDK::avsCommon::avs::AVSDirective> directive ) {
...
alexaClientSDK::avsCommon::avs::DirectiveHandlerConfiguration NavigationAssistanceCapabilityAgent::getConfiguration() const
{
...
NavigationAssistanceCapabilityAgent::NavigationAssistanceCapabilityAgent( std::shared_ptr<aace::engine::navigation::NavigationHandlerInterface> navigationHandler, std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ExceptionEncounteredSenderInterface> exceptionSender,
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::MessageSenderInterface> messageSender,
    std::shared_ptr<alexaClientSDK::avsCommon::sdkInterfaces::ContextManagerInterface> contextManager ) :
...
std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityConfiguration> getNavigationAssistanceCapabilityConfiguration() {
    std::unordered_map<std::string, std::string> configMap;
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_TYPE_KEY, NAVIGATION_ASSISTANCE_CAPABILITY_INTERFACE_TYPE} );
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_NAME_KEY, NAVIGATION_ASSISTANCE_CAPABILITY_INTERFACE_NAME} );
    configMap.insert( {alexaClientSDK::avsCommon::avs::CAPABILITY_INTERFACE_VERSION_KEY, NAVIGATION_ASSISTANCE_CAPABILITY_INTERFACE_VERSION} );
...
void NavigationAssistanceCapabilityAgent::sendExceptionEncounteredAndReportFailed( std::shared_ptr<DirectiveInfo> info, const std::string& message, alexaClientSDK::avsCommon::avs::ExceptionErrorType type )
{
...
void NavigationAssistanceCapabilityAgent::handleAnnounceManeuverDirective( std::shared_ptr<DirectiveInfo> info )
{
    ...
    if( !result ) {
        AACE_ERROR(LX(TAG, "handleAnnounceManeuverDirective").d("reason", rapidjson::GetParseError_En(result.Code())).d("messageId", info->directive->getMessageId()));
    ...
    if( !document.HasMember( "type" ) ) {
        ...
        sendExceptionEncounteredAndReportFailed( info, "Missing manueverType value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    ...
    if( announceManeuverTypeValues.find( manueuverType ) == announceManeuverTypeValues.end() ) {
        ...
        sendExceptionEncounteredAndReportFailed( info, "invalid manuever type value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
...
void NavigationAssistanceCapabilityAgent::handleAnnounceRoadRegulationDirective( std::shared_ptr<DirectiveInfo> info )
{
    ...
    rapidjson::ParseResult result = document.Parse(&payload[0]);
    if( !result ) {
        AACE_ERROR(LX(TAG, "handleAnnounceRoadRegulationDirective").d("reason", rapidjson::GetParseError_En(result.Code())).d("messageId", info->directive->getMessageId()));
        sendExceptionEncounteredAndReportFailed( info, "Unable to parse payload", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    if( !document.HasMember( "type" ) ) {
        AACE_ERROR(LX(TAG, "handleAnnounceRoadRegulationDirective").d("reason", "missing roadRegulationType value"));
        sendExceptionEncounteredAndReportFailed( info, "Missing roadRegulationType value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    ...
    if(roadRegulationTypeStringToEnumMap.find( roadRegulationType ) == roadRegulationTypeStringToEnumMap.end() ){
        ...
        sendExceptionEncounteredAndReportFailed( info, "invalid roadRegulationType value", alexaClientSDK::avsCommon::avs::ExceptionErrorType::UNEXPECTED_INFORMATION_RECEIVED);
        return;
    }
    aace::navigation::Navigation::RoadRegulation roadRegulation = roadRegulationTypeStringToEnumMap.find( roadRegulationType )->second;
...
void NavigationAssistanceCapabilityAgent::navigationEvent( aace::navigation::NavigationEngineInterface::EventName event )
{
...
void NavigationAssistanceCapabilityAgent::navigationError( aace::navigation::NavigationEngineInterface::ErrorType type, aace::navigation::NavigationEngineInterface::ErrorCode code, const std::string& description )
{
...
void NavigationAssistanceCapabilityAgent::executeNavigationEvent( aace::navigation::NavigationEngineInterface::EventName event )
{
...
void NavigationAssistanceCapabilityAgent::executeNavigationError( aace::navigation::NavigationEngineInterface::ErrorType type, aace::navigation::NavigationEngineInterface::ErrorCode code, const std::string& description )
{
...
std::string NavigationAssistanceCapabilityAgent::getManeuverErrorCode( aace::navigation::NavigationEngineInterface::ErrorCode code ) {
...
std::string NavigationAssistanceCapabilityAgent::getRoadRegulationErrorCode( aace::navigation::NavigationEngineInterface::ErrorCode code ) {
    std::string errorCodeString;
    switch ( code ) {
        case aace::navigation::NavigationEngineInterface::ErrorCode::NOT_SUPPORTED:
            errorCodeString = "NOT_SUPPORTED";
...
void NavigationAssistanceCapabilityAgent::announceManeuverSucceeded( std::string maneuverType )
{
    ...
    payload.AddMember("maneuverType", rapidjson::Value( maneuverType.c_str(), allocator ), allocator );
...
void NavigationAssistanceCapabilityAgent::announceManeuverFailed( std::string code, std::string description, std::string maneuverType )
{
    rapidjson::Document payload( rapidjson::kObjectType );
    rapidjson::Document::AllocatorType& allocator = payload.GetAllocator();
    payload.AddMember("maneuverType", rapidjson::Value( maneuverType.c_str(), allocator ), allocator );
...
void NavigationAssistanceCapabilityAgent::announceRoadRegulationSucceeded( std::string roadRegulationType )
{
    rapidjson::Document payload( rapidjson::kObjectType );
    rapidjson::Document::AllocatorType& allocator = payload.GetAllocator();
    payload.AddMember("roadRegulationType", rapidjson::Value( roadRegulationType.c_str(), allocator ), allocator );
...
void NavigationAssistanceCapabilityAgent::announceRoadRegulationFailed( std::string code, std::string description, std::string roadRegulationType )
{
    rapidjson::Document payload( rapidjson::kObjectType );
    rapidjson::Document::AllocatorType& allocator = payload.GetAllocator();
    payload.AddMember("roadRegulationType", rapidjson::Value( roadRegulationType.c_str(), allocator ), allocator );
...
std::unordered_set<std::shared_ptr<alexaClientSDK::avsCommon::avs::CapabilityConfiguration>> NavigationAssistanceCapabilityAgent::getCapabilityConfigurations() {
    return m_capabilityConfigurations;
}

} // aace::engine::navigation::navigationassistance
