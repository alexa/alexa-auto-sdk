...
typedef struct {
    ...
    /**
	 * The number of audio channels. For the player, it specifies the number of audio channels of input LPCM audio.
	 * The value is ignored if the input audio type is not LPCM. For the recorder, it specifies the number of audio
