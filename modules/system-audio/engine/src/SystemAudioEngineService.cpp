...
public:
    explicit AudioInputProviderImpl(std::weak_ptr<SystemAudioEngineService> service);
...
public:
    explicit AudioOutputProviderImpl(std::weak_ptr<SystemAudioEngineService> service);
