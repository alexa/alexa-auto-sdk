...
class AASBTextToSpeechEngineService : public aace::engine::messageBroker::MessageHandlerEngineService {
public:
    DESCRIBE("aasb.textToSpeech", VERSION("1.0"), DEPENDS(aace::engine::messageBroker::MessageBrokerEngineService))
