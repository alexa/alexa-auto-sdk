...
const std::string ACTION_NAVIGATION_START_NAVIGATION = "startNavigation";
...
const std::string VALUE_LOCAL_MEDIA_SOURCE_SIRIUS_XM = "SIRIUS_XM";
const std::string VALUE_LOCAL_MEDIA_SOURCE_DAB = "DAB";
...
const std::string VALUE_DISABLE_SHUFFLE = "DISABLE_SHUFFLE";
...
// AASB -> AASB Client
const std::string ACTION_CARCONTROL_TURN_POWER_CONTROLLER_ON = "turnPowerControllerOn";
const std::string ACTION_CARCONTROL_TURN_POWER_CONTROLLER_OFF = "turnPowerControllerOff";
const std::string ACTION_CARCONTROL_IS_POWER_CONTROLLER_ON = "isPowerControllerOn";
const std::string ACTION_CARCONTROL_IS_POWER_CONTROLLER_ON_RESPONSE = "isPowerControllerOnResponse";
const std::string ACTION_CARCONTROL_TURN_TOGGLE_CONTROLLER_ON = "turnToggleControllerOn";
const std::string ACTION_CARCONTROL_TURN_TOGGLE_CONTROLLER_OFF = "turnToggleControllerOff";
const std::string ACTION_CARCONTROL_IS_TOGGLE_CONTROLLER_ON = "isToggleControllerOn";
const std::string ACTION_CARCONTROL_IS_TOGGLE_CONTROLLER_ON_RESPONSE = "isToggleControllerOnResponse";
const std::string ACTION_CARCONTROL_SET_MODE_CONTROLLER_VALUE = "setModeControllerValue";
const std::string ACTION_CARCONTROL_ADJUST_MODE_CONTROLLER_VALUE = "adjustModeControllerValue";
const std::string ACTION_CARCONTROL_GET_MODE_CONTROLLER_VALUE = "getModeControllerValue";
const std::string ACTION_CARCONTROL_GET_MODE_CONTROLLER_VALUE_RESPONSE = "getModeControllerValueResponse";
const std::string ACTION_CARCONTROL_SET_RANGE_CONTROLLER_VALUE = "setRangeControllerValue";
const std::string ACTION_CARCONTROL_ADJUST_RANGE_CONTROLLER_VALUE = "adjustRangeControllerValue";
const std::string ACTION_CARCONTROL_GET_RANGE_CONTROLLER_VALUE = "getRangeControllerValue";
const std::string ACTION_CARCONTROL_GET_RANGE_CONTROLLER_VALUE_RESPONSE = "getRangeControllerValueResponse";
// AASB Client -> AASB
...
const std::string JSON_ATTR_CARCONTROL_CONTROL_ID = "controlId";
const std::string JSON_ATTR_CARCONTROL_CONTROLLER_ID = "controllerId";
...
const std::string VALUE_CARCONTROL_AC_INTENSITY_LOW = "LOW";
const std::string VALUE_CARCONTROL_AC_INTENSITY_MEDIUM = "MEDIUM";
const std::string VALUE_CARCONTROL_AC_INTENSITY_HIGH = "HIGH";
