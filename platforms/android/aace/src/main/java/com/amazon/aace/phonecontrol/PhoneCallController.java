...
abstract public class PhoneCallController extends PlatformInterface
{
    ...
    final protected void callStateChanged( CallState state, String callId ) {
        callStateChanged( getNativeObject(), state, callId );
    }
    ...
    final protected void callStateChanged( CallState state, String callId, String callerId ) {
        callStateChanged( getNativeObject(), state, callId, callerId );
    }
    ...
    final protected void callFailed( String callId, CallError code ) {
        callFailed( getNativeObject(), callId, code );
    }
    ...
    final protected void callFailed( String callId, CallError code, String message ) {
        callFailed( getNativeObject(), callId, code, message );
    }
    ...
    final protected void callerIdReceived( String callId, String callerId ) {
        callerIdReceived( getNativeObject(), callId, callerId );
    }
    ...
    final protected void sendDTMFSucceeded( String callId ) {
        sendDTMFSucceeded( getNativeObject(), callId );
    }
    ...
    final protected void sendDTMFFailed( String callId, DTMFError code ) {
        sendDTMFFailed( getNativeObject(), callId, code );
    }
    ...
    final protected void sendDTMFFailed( String callId, DTMFError code, String message ) {
        sendDTMFFailed( getNativeObject(), callId, code, message);
    }
    ...
    final protected void deviceConfigurationUpdated( HashMap<CallingDeviceConfigurationProperty, Boolean> configurationMap ) {
        ...
        deviceConfigurationUpdated( getNativeObject(), configurations, configurationValues );
    }
    ...
    private native void callStateChanged( long nativeObject, CallState state, String callId );
    private native void callStateChanged( long nativeObject, CallState state, String callId, String callerId );
    private native void callFailed( long nativeObject, String callId, CallError code );
    private native void callFailed( long nativeObject, String callId, CallError code, String message );
    private native void callerIdReceived( long nativeObject, String callId, String callerId );
    private native void sendDTMFSucceeded( long nativeObject, String callId );
    private native void sendDTMFFailed( long nativeObject, String callId, DTMFError code );
    private native void sendDTMFFailed( long nativeObject, String callId, DTMFError code, String message );
    private native void deviceConfigurationUpdated( long nativeObject, CallingDeviceConfigurationProperty[] configurations, boolean[] configurationValues );
    private native String createCallId( long nativeObject );
}
