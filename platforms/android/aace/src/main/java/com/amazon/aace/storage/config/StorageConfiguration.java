...
public class StorageConfiguration 
{
     ...
     */
    public static EngineConfiguration createLocalStorageConfig( String localStoragePath ) 
    {
        ...
        try
        {
            ...
            JSONObject aaceStorageElement = new JSONObject();

            aaceStorageElement.put( "localStoragePath", localStoragePath );
            rootElement.put( "aace.storage", aaceStorageElement );
