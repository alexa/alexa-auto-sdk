...
namespace alexa {
    ...
    void AlertsHandler::alertStateChanged( const std::string& alertToken, AlertState state, const std::string& reason )
    {
        try_with_context
        {
            ...
            ThrowIfNot( m_obj.invoke<void>( "alertStateChanged", "(Ljava/lang/String;Lcom/amazon/aace/alexa/Alerts$AlertState;Ljava/lang/String;)V", nullptr, JString(alertToken).get(), checkedStateObj, JString(reason).get() ), "invokeMethodFailed" );
        }
        catch_with_ex {
    ...
    void AlertsHandler::alertCreated( const std::string& alertToken, const std::string& detailedInfo )
    {
        try_with_context
        {
            ThrowIfNot( m_obj.invoke<void>( "alertCreated", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, JString(alertToken).get(), JString(detailedInfo).get() ), "invokeMethodFailed" );
        }
        catch_with_ex {
    ...
    void AlertsHandler::alertDeleted( const std::string& alertToken )
    {
        try_with_context
        {
            ThrowIfNot( m_obj.invoke<void>( "alertDeleted", "(Ljava/lang/String;)V", nullptr, JString(alertToken).get() ), "invokeMethodFailed" );
        }
        catch_with_ex {
...
extern "C"
{
    ...
    Java_com_amazon_aace_alexa_Alerts_createBinder( JNIEnv* env, jobject obj )
    {
        try
        {
    ...
    Java_com_amazon_aace_alexa_Alerts_disposeBinder( JNIEnv* env, jobject /* this */, jlong ref )
    {
        try
        {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_Alerts_localStop( JNIEnv* env, jobject /* this */, jlong ref )
    {
        try
        {
            auto alertsBinder = ALERTS_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_Alerts_removeAllAlerts( JNIEnv* env, jobject /* this */, jlong ref )
    {
        try
        {
            auto alertsBinder = ALERTS_BINDER(ref);
