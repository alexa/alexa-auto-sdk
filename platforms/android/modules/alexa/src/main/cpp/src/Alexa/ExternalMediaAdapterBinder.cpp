...
namespace alexa {
    ...
    ExternalMediaAdapterHandler::ExternalMediaAdapterHandler( jobject obj ) : m_obj( obj, "com/amazon/aace/alexa/ExternalMediaAdapter" ) {
    }

    bool ExternalMediaAdapterHandler::login( const std::string& localPlayerId, const std::string& accessToken, const std::string& userName, bool forceLogin, std::chrono::milliseconds tokenRefreshInterval )
    {
        try_with_context
        {
            jboolean result;

            ThrowIfNot( m_obj.invoke( "login", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)Z", &result,
                        JString(localPlayerId).get(), JString(accessToken).get(), JString(userName).get(),
                        forceLogin, tokenRefreshInterval.count() ), "invokeMethodFailed" );
    ...
    bool ExternalMediaAdapterHandler::logout( const std::string& localPlayerId )
    {
        ...
        {
            jboolean result;
            ThrowIfNot( m_obj.invoke( "logout", "(Ljava/lang/String;)Z", &result, JString(localPlayerId).get() ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
    ...
    bool ExternalMediaAdapterHandler::playControl( const std::string& localPlayerId, PlayControlType playControlType )
    {
        try_with_context
        {
            ...
            jboolean result;
            ThrowIfNot( m_obj.invoke( "playControl", "(Ljava/lang/String;Lcom/amazon/aace/alexa/ExternalMediaAdapter$PlayControlType;)Z", &result, JString(localPlayerId).get(), playControlTypeObj ), "invokeMethodFailed" );
    ...
    bool ExternalMediaAdapterHandler::seek( const std::string& localPlayerId, std::chrono::milliseconds offset )
    {
        ...
        {
            jboolean result;
            ThrowIfNot( m_obj.invoke( "seek", "(Ljava/lang/String;J)Z", &result, JString(localPlayerId).get(), offset.count() ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
    ...
    bool ExternalMediaAdapterHandler::adjustSeek( const std::string& localPlayerId, std::chrono::milliseconds deltaOffset )
    {
        ...
        {
            jboolean result;
            ThrowIfNot( m_obj.invoke( "adjustSeek", "(Ljava/lang/String;J)Z", &result, JString(localPlayerId).get(), deltaOffset.count() ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
    ...
    bool ExternalMediaAdapterHandler::authorize( const std::vector<AuthorizedPlayerInfo>& authorizedPlayers )
    {
        try_with_context
        {
            ...
            jboolean result;
            ThrowIfNot( m_obj.invoke( "authorize", "([Lcom/amazon/aace/alexa/ExternalMediaAdapter$AuthorizedPlayerInfo;)Z", &result, arr.get() ), "invokeMethodFailed" );
    ...
    bool ExternalMediaAdapterHandler::getState( const std::string& localPlayerId, ExternalMediaAdapterState& state )
    {
        try_with_context
        {
            ...
            ThrowIfNot( m_obj.invoke( "getState", "(Ljava/lang/String;Lcom/amazon/aace/alexa/ExternalMediaAdapter$ExternalMediaAdapterState;)Z", &result.z, JString(localPlayerId).get(), stateObj.get() ), "invokeMethodFailed" );
            ...
            ThrowIfNot( stateObj.get( "sessionState", "Lcom/amazon/aace/alexa/ExternalMediaAdapter$SessionState;", &result.l ), "getFieldFailed" )
            ...
            ThrowIfNot( playbackStateObj.get( "favorites", "Lcom/amazon/aace/alexa/ExternalMediaAdapter$Favorites;", &result.l ), "getFieldFailed" );
            ...
            ThrowIfNot( playbackStateObj.get( "mediaType", "Lcom/amazon/aace/alexa/ExternalMediaAdapter$MediaType;", &result.l ), "getFieldFailed" );
    ...
    bool ExternalMediaAdapterHandler::mutedStateChanged( MutedState state )
    {
        try_with_context
        {
            ...
            jboolean result;
            ThrowIfNot( m_obj.invoke( "mutedStateChanged", "(Lcom/amazon/aace/audio/AudioOutput$MutedState;)Z", &result, mutedStateObj ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
...
extern "C"
{
    ...
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_createBinder( JNIEnv* env, jobject obj )
    {
        try
        {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_reportDiscoveredPlayers( JNIEnv* env, jobject /* this */, jlong ref, jobjectArray discoveredPlayers )
    {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_requestToken( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId ) 
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_loginComplete( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_logoutComplete( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_playerEvent( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId, jstring eventName )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
            ThrowIfNull( externalMediaAdapterBinder, "invalidExternalMediaAdapterBinder" );
            externalMediaAdapterBinder->getExternalMediaAdapter()->playerEvent( JString(localPlayerId).toStdStr(), JString(eventName).toStdStr() );
        }
        catch( const std::exception& ex ) {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_playerError( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId, jstring errorName, jlong code, jstring description, jboolean fatal )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
            ThrowIfNull( externalMediaAdapterBinder, "invalidExternalMediaAdapterBinder" );
            externalMediaAdapterBinder->getExternalMediaAdapter()->playerError( JString(localPlayerId).toStdStr(), JString(errorName).toStdStr(), code, JString(description).toStdStr(), fatal );
        }
        catch( const std::exception& ex ) {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_setFocus( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_ExternalMediaAdapter_removeDiscoveredPlayer( JNIEnv* env, jobject /* this */, jlong ref, jstring localPlayerId )
    {
        try
        {
            auto externalMediaAdapterBinder = EXTERNAL_MEDIA_ADAPTER_BINDER(ref);
            ThrowIfNull( externalMediaAdapterBinder, "invalidExternalMediaAdapterBinder" );
            externalMediaAdapterBinder->getExternalMediaAdapter()->removeDiscoveredPlayer( JString(localPlayerId).toStdStr() );
        }
        catch( const std::exception& ex ) {
