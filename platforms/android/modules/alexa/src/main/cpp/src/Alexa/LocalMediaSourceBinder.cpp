...
namespace alexa {
    ...
    LocalMediaSourceHandler::LocalMediaSourceHandler( jobject obj, Source source ) : LocalMediaSource( source ), m_obj( obj, "com/amazon/aace/alexa/LocalMediaSource") {
    }
    ...
    bool LocalMediaSourceHandler::play( ContentSelector selector, const std::string& payload )
    {
        try_with_context
        {
            ...
            ThrowIfNot( m_obj.invoke( "play", "(Lcom/amazon/aace/alexa/LocalMediaSource$ContentSelector;Ljava/lang/String;)Z", &result, selectorTypeObj, JString(payload).get() ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
    ...
    bool LocalMediaSourceHandler::playControl( PlayControlType controlType )
    {
        try_with_context
        {
            ...
            ThrowIfNot( m_obj.invoke( "playControl", "(Lcom/amazon/aace/alexa/LocalMediaSource$PlayControlType;)Z", &result, controlTypeObj ), "invokeMethodFailed" );
            return result;
        }
        catch_with_ex {
    ...
    LocalMediaSourceHandler::LocalMediaSourceState LocalMediaSourceHandler::getState()
    {
        ...
        {
            jvalue result;
            ThrowIfNot( m_obj.invoke( "getState", "()Lcom/amazon/aace/alexa/LocalMediaSource$LocalMediaSourceState;", &result.l ), "invokeMethodFailed" );
            ...
            ThrowIfNot( localMediaSourceState.get( "sessionState", "Lcom/amazon/aace/alexa/LocalMediaSource$SessionState;", &result.l ), "getFieldFailed" );
            ...
            ThrowIfNot( sessionStateObj.get( "supportedContentSelectors", "[Lcom/amazon/aace/alexa/LocalMediaSource$ContentSelector;", &result.l ), "getFieldFailed" );
            ...
            ThrowIfNot( localMediaSourceState.get( "playbackState", "Lcom/amazon/aace/alexa/LocalMediaSource$PlaybackState;", &result.l ), "getFieldFailed" );
            ...
            ThrowIfNot( playbackStateObj.get( "favorites", "Lcom/amazon/aace/alexa/LocalMediaSource$Favorites;", &result.l ), "getFieldFailed" );
            ...
            ThrowIfNot( playbackStateObj.get( "mediaType", "Lcom/amazon/aace/alexa/LocalMediaSource$MediaType;", &result.l ), "getFieldFailed" );
...
extern "C"
{
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_alexa_LocalMediaSource_playerError( JNIEnv * env , jobject /* this */, jlong ref, jstring errorName, jlong code, jstring description, jboolean fatal )
    {
        try
        {
            auto localMediaSourceBinder = LOCAL_MEDIA_SOURCE_BINDER(ref);
            ...
            localMediaSourceBinder->getLocalMediaSource()->playerError( JString(errorName).toStdStr(), code, JString(description).toStdStr(), fatal );
        }
        catch( const std::exception& ex ) {
