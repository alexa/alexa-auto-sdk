...
/**
 * Provides a {@link SequentialExecutor} for use in network calls.
 */
public class NetworkExecutor extends SequentialExecutor {
    public NetworkExecutor() {
        super(Threading.createSequentialExecutor());
    }
}
