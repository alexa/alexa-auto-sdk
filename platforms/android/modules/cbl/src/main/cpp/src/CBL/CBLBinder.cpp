...
namespace cbl {
    ...
    void CBLHandler::setRefreshToken( const std::string& refreshToken ) 
    {
        try_with_context 
        {
            ThrowIfNot( m_obj.invoke<void>( "setRefreshToken", "(Ljava/lang/String;)V", nullptr, JString(refreshToken).get() ), "invokeMethodFailed" );
        }
        catch_with_ex {
    ...
    void CBLHandler::setUserProfile( const std::string& name, const std::string& email ) {
        try_with_context
        {
            ThrowIfNot( m_obj.invoke<void>( "setUserProfile", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, JString(name).get(), JString(email).get() ), "invokeMethodFailed" );
        }
        catch_with_ex {
...
extern "C"
{
    ...
    Java_com_amazon_aace_cbl_CBL_createBinder( JNIEnv * env, jobject obj ) {
        return reinterpret_cast<long>( new aace::jni::cbl::CBLBinder( obj ) );
    }

    JNIEXPORT void JNICALL
    Java_com_amazon_aace_cbl_CBL_disposeBinder( JNIEnv* env, jobject /* this */, jlong ref )
    {
        try
        {
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_cbl_CBL_start( JNIEnv * env, jobject /* this */, jlong ref )
    {
        try
        {
            auto cblBinder = CBL_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_cbl_CBL_cancel(JNIEnv * env, jobject /* this */, jlong ref)
    {
        try
        {
            auto cblBinder = CBL_BINDER(ref);
    ...
    JNIEXPORT void JNICALL
    Java_com_amazon_aace_cbl_CBL_reset(JNIEnv * env, jobject /* this */, jlong ref)
    {
        try
        {
            auto cblBinder = CBL_BINDER(ref);
