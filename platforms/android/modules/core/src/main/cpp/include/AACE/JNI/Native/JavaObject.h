...
namespace native {
    ...
    public:
        ...
        template <class T> bool invokeV( JavaMethodPtr method, T* result, va_list );
        template <class T> bool invoke( JavaMethodPtr method, T* result, ... );
        template <class T> bool invoke( const char* name, const char* signature, T* result, ... );

        template <class T> bool set( const char* name, const char* signature, T value );
        template <class T> bool set( const char* name, T value );
        template <class T> bool set( JavaFieldPtr field, T value );
        template <class T> bool get( const char* name, const char* signature, T* value );
        template <class T> bool get( const char* name, T* value );
        template <class T> bool get( JavaFieldPtr field, T* value );
    ...
    template <class T> bool JavaObject::invokeV( JavaMethodPtr method, T* result, va_list ) {
        AACE_JNI_ERROR("aace.jni.native.JavaObject","invokeV","undefinedTypeSpecification");
        return false;
    }

    template <class T> bool JavaObject::invoke( JavaMethodPtr method, T* result, ... )
    {
        try_with_context
        {
            // start - handle vargs
    ...
    template <class T> bool JavaObject::invoke( const char* name, const char* signature, T* result, ... )
    {
        try_with_context
        {
    ...
    template <class T> bool JavaObject::set( const char* name, const char* signature, T value )
    {
        try_with_context
        {
    ...
    template <class T> bool JavaObject::get( const char* name, const char* signature, T* value )
    {
        try_with_context
        {
            auto field = getField( name, signature );
