...
#define ThrowIfJavaEx(env,reason) if(env->ExceptionCheck()){env->ExceptionDescribe();env->ExceptionClear();throw std::runtime_error(reason);}
...
#define AACE_JNI_DEBUG(tag,method,msg) __android_log_print(ANDROID_LOG_DEBUG, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)
#define AACE_JNI_VERBOSE(tag,method,msg) __android_log_print(ANDROID_LOG_VERBOSE, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)
...
#define AACE_JNI_INFO(tag,method,msg) __android_log_print(ANDROID_LOG_INFO, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)
#define AACE_JNI_WARN(tag,method,msg) __android_log_print(ANDROID_LOG_WARN, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)
#define AACE_JNI_ERROR(tag,method,msg) __android_log_print(ANDROID_LOG_ERROR, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)
#define AACE_JNI_CRITICAL(tag,method,msg) __android_log_print(ANDROID_LOG_FATAL, LOGGING_MODULE_NAME, "%s:%s:%s", tag, method, msg)

// try with context
#define try_with_context try { \
