...
namespace navigation {
    ...
    public:
        ...
        std::vector<std::pair<T,std::string>> getConfiguration() override {
            return {
                    {T::DEFAULT, "DEFAULT"},
                    {T::SHORTER_TIME, "SHORTER_TIME"},
                    {T::SHORTER_DISTANCE, "SHORTER_DISTANCE"}
            };
        }
    };
    ...
    public:
        ...
        std::vector<std::pair<T,std::string>> getConfiguration() override {
            return {
                    {T::SHOW_ROUTE_OVERVIEW, "SHOW_ROUTE_OVERVIEW"},
    ...
    public:
        ...
        std::vector<std::pair<T,std::string>> getConfiguration() override {
            return {
                    {T::NAVIGATION_STARTED, "NAVIGATION_STARTED"},
    ...
    public:
        ...
        std::vector<std::pair<T,std::string>> getConfiguration() override {
            return {
                    {T::NAVIGATION_START_FAILED, "NAVIGATION_START_FAILED"},
    ...
    public:
        ...
        std::vector<std::pair<T,std::string>> getConfiguration() override {
            return {
                    {T::INTERNAL_SERVICE_ERROR, "INTERNAL_SERVICE_ERROR"},
