...
public class ViewHolderLocalSearchDetailTemplate1 extends RecyclerView.ViewHolder {
    ...
    public TextView getPhoneNumber() { return mPhoneNumber; }
    public TextView getProvider() { return mProvider; }
    ...
    public TextView getOffRouteTime() { return mOffRouteTime; }
    public TextView getPriceRange() { return mPriceRange; }

    //public TextView getURL() { return mURL; }
    public TextView getRatingValue() { return mRatingValue; }
    public TextView getRatingReviewCount() { return mRatingReviewCount; }
    public ImageView getRatingImage() { return mRatingImage; }
    public TextView getRatingProviderName() { return mRatingProviderName; }
    public ImageView getRatingProviderImage() { return mRatingProviderImage; }
    ...
    public TextView getCurrentStatus() { return mCurrentStatus; }
    //public TextView getTravelDirection() { return mTravelDirection; }
    public TextView getWeekdayHours() { return mWeekdayHours; }
    public TextView getSaturdayHours() { return mSaturdayHours; }
    public TextView getSundayHours() { return mSundayHours; }
}
