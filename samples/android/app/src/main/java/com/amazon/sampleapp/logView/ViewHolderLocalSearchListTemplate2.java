...
class ViewHolderLocalSearchListTemplate2 extends RecyclerView.ViewHolder {
    ...
    public void insertListItem(String index, String mainTitle, String subTitle,
                               String address, String phoneNumber, String provider, String image, String travelDistance,
                               String travelTime, String offRouteTime, String priceRange, String ratingValue,
                               String ratingReviewCount, String ratingImage, String ratingProviderName,
                               String ratingProviderImage, String currentStatus ) {
