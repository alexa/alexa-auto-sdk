...
import com.amazon.sampleapp.DownloadImageTask;
...
public class ConfigureViewHolder
{
    //configure individual objects
    public static void configureTextLog( ViewHolderTextLog vh, JSONObject json )
    {
        try
        {
    ...
    public static void configureBodyTemplate1( ViewHolderBodyTemplate1 vh, JSONObject json )
    {
        try
        {
    ...
    public static void configureBodyTemplate2( ViewHolderBodyTemplate2 vh, JSONObject json )
    {
        try
        {
            if( json.has( "template" ) )
            {
                ...
                if ( template.has( "image" ) )
                {
                    ...
                    new DownloadImageTask( (ImageView) vh.getImage() ).execute( imageURL );
                }
            }
    ...
    public static void configureListTemplate1( ViewHolderListTemplate1 vh, JSONObject json )
    {
        try {
            ...
            if( json.has( "template" ) )
            {
                ...
                if ( template.has( "listItems" ) )
                {
                    ...
                    // truncate list to show 5 items
                    int numItems = listItems.length() > 5 ? 5 : listItems.length();
    ...
    public static void configureWeatherTemplate( ViewHolderWeatherTemplate vh, JSONObject json )
    {
        try
        {
            if( json.has( "template" ) ) {
                ...
                if ( template.has( "currentWeatherIcon" ) )
                {
                    ...
                    new DownloadImageTask( ( ImageView ) vh.getCurrentWeatherIcon() ).execute( currentWeatherIconURL );
                }
    ...
    public static void configureSetDestinationTemplate( ViewHolderSetDestinationTemplate vh, JSONObject json )
    {
        try
        {
            if( json.has( "template" ) )
                ...
                if ( template.has( "destination" ) )
                {
                    ...
                    if ( dest.has( "coordinate" ) )
                    {
                        ...
                        String imageURL = "https://maps.google.com/maps/api/staticmap?"
                                ...
                                + "&sensor=false";
                        new DownloadImageTask( (ImageView) vh.getMapContainer() ).execute( imageURL );
                    }
    ...
    public static void configureLocalSearchListTemplate1( ViewHolderLocalSearchListTemplate1 vh, JSONObject json )
    {
        try
        {
            if( json.has( "template" ) )
            {
                ...
                if ( template.has( "listItems" ) )
                {
                    ...
                    // truncate list to show 4 items
                    int numListItems = listItems.length() > 4 ? 4 : listItems.length();
    ...
    public static void configureRenderPlayerInfo( ViewHolderRenderPlayerInfo vh, JSONObject json )
    {
        try
        {
            if( json.has( "template" ) )
            {
                ...
                if ( template.has( "art" ) )
                {
                    ...
                    new DownloadImageTask( (ImageView) vh.getArt() ).execute( url );
                }
                else
                {
                ...
                if ( template.has( "provider" ) )
                {
                    ...
                    if ( provider.has( "logo" ) )
                    {
                        ...
                        new DownloadImageTask( (ImageView) vh.getPartnerLogo() ).execute( url );
                    }
                    else
                    {
    ...
    public static void configureDefaultLog( ViewHolderTextLog vh )
    {
        try
        {
    ...
    public static void configureImageLog( ViewHolderImageLog vh )
    {
        vh.getImageView().setImageResource( R.drawable.ic_action_tap_to_talk );
    }
