...
class ApplicationContext {
  private:
    ...
    bool m_wakeWordSupported{false};
    json m_menuRegister{};
    ...
    std::string m_renderPlayerInfoCommand{};
    std::string m_renderTemplateCommand{};
  ...
  public:
    ...
    auto getRenderPlayerInfoCommand() -> std::string;
    auto getRenderTemplateCommand() -> std::string;
    ...
    auto setRenderPlayerInfoCommand(const std::string &renderPlayerInfoCommand) -> void;
    auto setRenderTemplateCommand(const std::string &renderTemplateCommand) -> void;
    auto setSingleThreadedUI(bool singleThreadedUI) -> void;
    auto setUserConfigFilePath(const std::string &userConfigFilePath) -> void;
    auto setWakeWordSupported(bool wakeWordDetectionEnabled) -> void;
