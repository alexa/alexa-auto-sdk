...
private:
    /**
     * Handles the SetIndicatorMessage received from the Engine.
     *
     * @param [in] message The message received from the Engine
     */
    void handleSetIndicatorMessage(const std::string& message);

    /**
     * Handles whether a notification indicator should be rendered or not
     *
     * @param [in] state The new notification indicator state
     */
    void setIndicator(aasb::message::alexa::notifications::IndicatorState state);

    /**
     * Handles the OnNotificationReceivedMessage  received from the Engine.
     * @param [in] message The message received from the Engine
     */
    void handleOnNotificationReceived(const std::string& message);
