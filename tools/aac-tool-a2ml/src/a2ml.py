...
parser.add_argument( "-p", "--parser",
    help="parser to use for creating the A2ML model",
    default="A2ML"
)
parser.add_argument( "-g", "--generator",
    help="generator to use for processing A2ML model and creating output files",
    default="AASB"
)
...
parser.add_argument( "-d", "--dependencies",
    metavar="DIR",
    nargs="+",
    help="directory containing dependency input files"
)

parser.add_argument( "--message-version",
    help="AASB message version"
)
